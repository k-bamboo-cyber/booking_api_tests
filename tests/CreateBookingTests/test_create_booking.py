...
class TestGetBookingIds:
    ...
    def test_create_new_booking(self, client):
        ...
        booking_info = schema.validate(res.json())
    ...
    @pytest.mark.parametrize("field,value", [
        ('totalprice', 100000), ('totalprice', 0),
    ...
    def test_create_booking_with_invalid_totalprice(self, field, value, client):
        """
    ...
    @pytest.mark.parametrize("field,value", [
        ('depositpaid', ''), ('depositpaid', 'Y')
    ])
    def test_create_booking_with_invalid_depositpaid(self, field, value, client):
        """
    ...
    @pytest.mark.parametrize("checkin,checkout",
                             [pytest.param(
                                 '', '', marks=pytest.mark.xfail), ('2012-07-24', '2017-07-24')])
